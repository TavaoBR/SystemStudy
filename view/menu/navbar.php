                           ...
                           ?>
                            ...
                            if(isset($_SESSION['usuarioID'])){
                                ...
                                <div class='dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown'>
                                    ...
                                    <!-- item-->
                                    <a href='http://localhost/System/StudSystem/view/user/login.php' class='dropdown-item notify-item'>
                                        <i class='mdi mdi-account-circle me-1'></i>
                                        <span>Sign</span>
                                    </a>

                                    <!-- item-->
                                    <a href='http://localhost/System/StudSystem/view/user/cadastro.php' class='dropdown-item notify-item'>
                                        <i class='mdi mdi-account-edit me-1'></i>
                                        <span>Signup</span>
                                    </a>
                                </div>
